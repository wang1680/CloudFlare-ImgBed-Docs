...
3. Paste and execute the content below the comments in the SQL input box. (see [project repository](https://github.com/MarSeventh/CloudFlare-ImgBed/blob/main/database/init.sql))
4. Click "Execute"
